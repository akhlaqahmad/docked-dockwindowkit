...
#ifndef DOCKWINDOWKIT_SWIFT_H
#define DOCKWINDOWKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DockWindowKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <code>NSPanel</code> subclass that hosts a single floating dock.
/// <ul>
///   <li>
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC13DockWindowKit17FloatingDockPanel")
@interface FloatingDockPanel : NSPanel
